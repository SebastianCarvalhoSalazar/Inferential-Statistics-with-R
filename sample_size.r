...
qplot(tamano_muestral, media_estimada, data = simulaciones) +
  geom_hline(yintercept = simulaciones$media, colour = colores[4]) +
  theme_minimal()

qplot(tamano_muestral, dif_cuad_medias, data = simulaciones) +
  geom_smooth(size = 1, se = FALSE, colour = colores[4]) +
  theme_minimal()


qplot(tamano_muestral, desv_est_estimada, data = simulaciones) +
  geom_hline(yintercept = simulaciones$desv_est, colour = colores[4]) +
  theme_minimal()
...
qplot(tamano_muestral, maximo_estimado, data = simulaciones) +
  geom_hline(yintercept = simulaciones$maximo_poblacional, colour = colores[4]) +
  theme_minimal()
...
qplot(tamano_muestral, minimo_estimado, data = simulaciones) +
  geom_hline(yintercept = simulaciones$minimo_poblacional, colour = colores[4]) +
  theme_minimal()
...
qplot(tamano_muestral, beta_0_estimado, data = simulaciones) +
  geom_hline(yintercept = beta_0, colour = colores[4]) +
  theme_minimal()
...
qplot(tamano_muestral, beta_1_estimado, data = simulaciones) +
  geom_hline(yintercept = beta_1, colour = colores[4]) +
  theme_minimal()
